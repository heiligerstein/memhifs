...
/* Define to 1 if you have the `memcache' library (-lmemcache). */
#define HAVE_LIBMEMCACHE 1
...
/* Define to 1 if you have the <memcache.h> header file. */
